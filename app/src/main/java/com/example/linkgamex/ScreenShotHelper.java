...
public class ScreenShotHelper {
    ...
    public ScreenShotHelper(Context context, int resultCode, Intent data, OnScreenShotListener onScreenShotListener) {
        ...
        mImageReader = ImageReader.newInstance(LinkGameXUtils.getScreenWidth(), LinkGameXUtils.getScreenHeight(),
    ...
    private void virtualDisplay() {
        mVirtualDisplay = mMediaProjection.createVirtualDisplay("screen-mirror",
                LinkGameXUtils.getScreenWidth(),
                LinkGameXUtils.getScreenHeight(),
